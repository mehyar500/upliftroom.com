      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-6">
          ...
          <section className="bg-white dark:bg-gray-900 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-800">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">We use collected information to:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <section className="bg-white dark:bg-gray-900 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-800">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Age Restriction</h2>
            <p className="text-gray-700 dark:text-gray-300">
