...
export default function LatestPage() {
  useSEO({
    title: "Latest",
    description:
      "Stay up to date with the latest cannabis news, culture, and insights curated from trusted sources.",
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="section-subtitle mx-auto" style={{ maxWidth: "520px" }}>
            Cannabis culture, industry news, and lifestyle reads — curated for
            you.
          </p>
        </div>
        ...
        {featured && (
          <a
            href={featured.link}
            target={
              featured.content && featured.content.trim().length > 100
                ? undefined
                : "_blank"
            }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {rest.map((item) => (
            <a
              ...
              href={item.link}
              target={
                item.content && item.content.trim().length > 100
                  ? undefined
                  : "_blank"
              }
              rel="noopener noreferrer"
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        ...
                        placeholder.innerHTML =
                          '<svg class="w-10 h-10 opacity-15" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>';
